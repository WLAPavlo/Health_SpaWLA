...
function create_spa_event_cpt() {
    ...
    $args = array(
        ...
        'taxonomies'            => array('spa_event_category', 'spa_event_tag'),
        'hierarchical'          => false,
        'public'                => true,
        'show_ui'               => true,
        'show_in_menu'          => true,
...
function create_spa_event_taxonomies() {
    ...
    register_taxonomy('spa_event_category', array('spa_event'), $args);
    ...
    register_taxonomy('spa_event_tag', array('spa_event'), $args);
}
